...
func isSupportedSyzkall(c *prog.Syscall, target *prog.Target, sandbox string) (bool, string) {
	...
	if c.CallName == "syz_net_down_sleep_up" || c.CallName == "syz_usleep" || c.CallName == "syz_reboot" ||
		c.CallName == "syz_failure_net_down" || c.CallName == "syz_failure_net_up" || c.CallName == "syz_net_delay_add" || c.CallName == "syz_net_delay_del" ||
		c.CallName == "syz_failure_recv" || c.CallName == "syz_failure_send" || c.CallName == "syz_failure_sync" ||
		c.CallName == "syz_failure_up" || c.CallName == "syz_failure_down" || c.CallName == "syz_failure_barrier" {
		return true, ""
	}
